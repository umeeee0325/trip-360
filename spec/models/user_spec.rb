...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録できないとき' do
      ...
      it 'profileが16文字以上では登録できない' do
        @user.profile = 'aaaaaaaaaaaaaaaa'
        @user.valid?
        expect(@user.errors.full_messages).to include("Profile is too long (maximum is 15 characters)")
      end
